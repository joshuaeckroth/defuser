...
% queries:
% placeDice([["{w#=w#}", [die(g,6)]], ["{wn,wn}", []]], [die(b,2), die(r,6)], UpdatedCards, LeftoverDice).
% placeDice([["{w#=w#}", [die(g,6)]], ["{wn,wn}", []]], [die(b,2), die(r,6)], UpdatedCards,
% placeDice([["{w#=w#}", [die(g,6)]], ["{wn,wn}", []]], [die(b,2), die(r,6), die(b,1)], UpdatedCards, LeftoverDice).
% placeDice([["{w#=w#}", [die(g,6)]], ["{wn,wn}", []]], [die(b,2), die(r,6), die(b,1), die(b,5)], UpdatedCards, LeftoverDice).
